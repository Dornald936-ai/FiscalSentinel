...
# CORS
# -------------------------------------------------------------------
# Local React/Vite development servers, plus the deployed Vercel
# frontend. Extra production origins can be added via the
# CORS_EXTRA_ORIGINS env var (comma-separated) without a code change.
# Vercel preview deployments (random *.vercel.app subdomains) are
# matched with allow_origin_regex.
# -------------------------------------------------------------------
...
_default_origins = [
    ...
    "http://localhost:3000",
    "http://127.0.0.1:3000",
    "https://fiscal-sentinel-xi.vercel.app",
]
_extra_origins = [
    origin.strip()
